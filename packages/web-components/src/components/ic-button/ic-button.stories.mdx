    ...
    {html` <div
      ...
      >
        ...
        >
          ...
          <div>
            <ic-button variant="primary" monochrome> Monochrome </ic-button>
    ...
    {html` <div
      ...
      >
        ...
        >
          ...
          <div>
            <ic-button variant="secondary" monochrome> Monochrome </ic-button>
    ...
    {html` <div
      ...
      >
        ...
        >
          ...
          <div>
            <ic-button variant="tertiary" monochrome> Monochrome </ic-button>
...
<Canvas>
  <Story name="Icon variants" parameters={{ loki: { skip: true } }}>
    {html`<div style="display:flex; gap: 1rem; flex-direction:column;">
      ...
      <h1>Dark</h1>
      <div style="background-color:#474A48; padding: 0.5rem; width: fit-content;">
        <div>
          <ic-button
            variant="icon-primary"
            aria-label="refresh"
