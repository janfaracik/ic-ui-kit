...
<Canvas>
  <Story name="Object 1" parameters={{ loki: { skip: true } }}>
    {(args) =>
      html`<ic-select
          id="select-1"
          label="What is your favourite coffee?"
        ...
        <script>
          ...
          select.options = [
            { label: "Cappuccino", value: '{"foo": "string"}' },
            { label: "Coffee", value: "test" }
          ];
...
<Canvas>
  <Story name="Object 2" parameters={{ loki: { skip: true } }}>
    {(args) =>
      html`<ic-select
          id="select-1"
          label="What is your favourite coffee?"
...
<Canvas>
  <Story name="Object 3" parameters={{ loki: { skip: true } }}>
    {(args) =>
      html`<ic-select
          id="select-1"
          label="What is your favourite coffee?"
