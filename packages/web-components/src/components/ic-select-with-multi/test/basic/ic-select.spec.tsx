...
const menuUl = "ic-menu-with-multi ul";
...
const getTestSelect = (props: string) =>
  `<ic-select-with-multi label="IC Select Test" ${props}></ic-select-with-multi>
  <script>
...
describe("ic-select-with-multi single", () => {
  ...
  it("should test select as submit on form", async () => {
    const page = await newSpecPage({
      ...
      html: `<form id="new-form"></form><ic-select-with-multi id="ic-select-with-multi" form="new-form" label="IC Select Test" value="test-value"></ic-select-with-multi>`,
    });
  ...
  it("should test with clear button", async () => {
    ...
    const page = await newSpecPage({
      components: [Select, Menu, InputComponentContainer, Button],
      html: `<ic-select-with-multi label="IC Select Test" show-clear-button="true" value="test-value"></ic-select-with-multi>`,
    });
  ...
  it("should test menu handleKeyboardOpen method - arrow down (custom select)", async () => {
    const page = await newSpecPage({
      components: [Select, Menu, InputComponentContainer],
      html: `<ic-select-with-multi label="IC Select Test"></ic-select-with-multi>`,
    });

    page.root.options = menuOptions;
    await page.waitForChanges();

    const menu = page.root.shadowRoot.querySelector("ic-menu-with-multi");
  ...
  it("should test keydown on menu - space key (custom)", async () => {
    ...
    const list = page.root.shadowRoot.querySelector("ic-menu-with-multi ul");
  ...
  it("should test loading state and timeout for custom select", async () => {
    const page = await newSpecPage({
      components: [Select, Menu, InputComponentContainer],
      html: `<ic-select-with-multi label="IC Select Test" timeout="1000"></ic-select-with-multi>`,
    });
    const eventSpy = jest.fn();
    ...
    const retryButton = page.root.shadowRoot
      .querySelector("ic-menu-with-multi")
...
describe("ic-select-with-multi single native", () => {
  beforeEach(() => {
...
describe("ic-select-with-multi searchable", () => {
  ...
  it("should test with clear button with searchable", async () => {
    const page = await newSpecPage({
      components: [Select, Menu, InputComponentContainer, Button],
      html: `<ic-select-with-multi label="IC Select Test" searchable="true"></ic-select-with-multi>`,
    });
    page.root.options = menuOptions;
  ...
  it("should test click on input with external filtering", async () => {
    const page = await newSpecPage({
      components: [Select, Menu, InputComponentContainer],
      html: `<ic-select-with-multi label="IC Select Test" searchable="true" disable-filter="true"></ic-select-with-multi>`,
    });
  ...
  it("should test searchable input - with search match position set to start", async () => {
    const page = await newSpecPage({
      components: [Select, Menu, InputComponentContainer],
      html: `<ic-select-with-multi label="IC Select Test" searchable="true" search-match-position="start"></ic-select-with-multi>`,
    });
  ...
  it("should test searchable input - with descriptions and descriptions included in search", async () => {
    const page = await newSpecPage({
      components: [Select, Menu, InputComponentContainer],
      html: `<ic-select-with-multi label="IC Select Test" searchable="true" include-descriptions-in-search="true"></ic-select-with-multi>`,
    });
  ...
  it("should test searchable input - with search match position set to start and descriptions included in search", async () => {
    const page = await newSpecPage({
      components: [Select, Menu, InputComponentContainer],
      html: `<ic-select-with-multi label="IC Select Test" searchable="true" search-match-position="start" include-descriptions-in-search="true"></ic-select-with-multi>`,
    });
  ...
  it("should test searchable input - with groups and group titles included in search", async () => {
    const page = await newSpecPage({
      components: [Select, Menu, InputComponentContainer],
      html: `<ic-select-with-multi label="IC Select Test" searchable="true" include-group-titles-in-search="true"></ic-select-with-multi>`,
    });
  ...
  it("should test form reset event", async () => {
    const page = await newSpecPage({
      components: [Select],
      html: `<form>
        <ic-select-with-multi label="IC Select Test" searchable="true"></ic-select-with-multi>
  ...
  it("should test debounce change", async () => {
    const page = await newSpecPage({
      components: [Select, Menu, InputComponentContainer],
      html: `<ic-select-with-multi label="IC Select Test" searchable="true" disable-filter="true" debounce="300"></ic-select-with-multi>`,
    });
  ...
  it("should set the default value of searchable as custom value when not matching options", async () => {
    const page = await newSpecPage({
      components: [Select, Menu, InputComponentContainer],
      html: `<ic-select-with-multi label='Select test' searchable='true' value='Test value 01'></ic-select-with-multi>`,
    });
  ...
  it("should test loading state and timeout for searchable select with external filtering", async () => {
    const page = await newSpecPage({
      components: [Select, Menu, InputComponentContainer],
      html: `<ic-select-with-multi label="IC Select Test" searchable="true" disable-filter="true" debounce="300" timeout="1000"></ic-select-with-multi>`,
    });
  ...
  it("should stop the timeout if clear button is clicked before timeout", async () => {
    const page = await newSpecPage({
      components: [Select, Menu, InputComponentContainer],
      html: `<ic-select-with-multi label="IC Select Test" searchable="true" timeout="1000"></ic-select-with-multi>`,
    });
    page.rootInstance.searchableSelectInputValue = "test";
    await page.waitForChanges();
...
describe("ic-select-with-multi multi", () => {
  it("should not render a native select on a mobile / tablet screen", async () => {
    ...
    const page = await newSpecPage({
      components: [Select, Menu, InputComponentContainer, Button],
      html: `<ic-select-with-multi label="IC Select Test" multiple="true"></ic-select-with-multi>`,
    });
